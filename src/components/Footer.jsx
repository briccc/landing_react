    ...
    return (
        <footer className='mt-20 border-t py-10 border-neutral-700'>
            <div className='grid grid-cols-2 lg:grid-cols-3 gap-4'>
                <div>
                    <h3 className='text-md font-semibold mb-4 mt-2'>Fuentes</h3>
                ...
                <div>
                    <h3 className='text-md font-semibold mb-4 mt-2'>Plataformas</h3>
                    <ul className='space-y-2'>
                ...
                <div>
                    <h3 className='text-md font-semibold mb-4 mt-2'>Comunidad</h3>
                    <ul className='space-y-2'>
